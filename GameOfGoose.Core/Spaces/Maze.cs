...
{
    /// <summary>
    /// Represents the Maze space, implements the ISpace interface.
    /// </summary>
    public class Maze : ISpace
    {
        ...
        /// <summary>
        /// Initializes a new instance of <see cref="Maze"/> with the specified space number and destination.
        /// </summary>
        ...
        public Maze(int spaceNumber, int destination)
        {
