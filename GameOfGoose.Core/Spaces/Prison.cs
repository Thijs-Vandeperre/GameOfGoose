...
{
    /// <summary>
    /// Represents the Prison space, implements the ISpace interface.
    /// </summary>
    public class Prison : ISpace
    {
        ...
        /// <summary>
        /// Initializes a new instance of <see cref="Prison"/> with the specified space number and skip turns.
        /// </summary>
        ...
        public Prison(int spaceNumber, int skipTurns)
        {
